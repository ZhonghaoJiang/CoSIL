...
if __name__ == "__main__":
    # 加载数据
    loc_outputs_json = load_json('./assets/orcar_verified_parsed_output_output_32b.json')
    ...
    print(loc_outputs)
    save_jsonl(loc_outputs, '../loc_to_patch_verified/orcaloca/orca_qwen_coder_32b_func.jsonl')
