...
if __name__ == "__main__":
    # 加载数据
    loc_outputs_json = load_json('./assets/orcar_parsed_output_output_qwen_coder_14b.json')
    ...
    print(loc_outputs)
    save_jsonl(loc_outputs, '../results/orcaloca/orca_qwen_coder_14b_func.jsonl')
